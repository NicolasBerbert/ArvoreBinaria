Esse código foi criado para fins acadêmicos, o código é capaz de criar e remover nós de uma árvore binária, algoritmo de busca eficiente que utiliza ponteiros para a manipulação de nós.
